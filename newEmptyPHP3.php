...
$password = "root";
$dbname = "localdb";
    $db = mysqli_connect('127.0.0.1', 'root', 'root', 'localdb')
...
$mysql = new mysqli('localhost', 'root', 'root','localdb');

// Получение основных данных организации
$url = 'https://101hotels.com/opinions/hotel/volzhskiy/gostinitsa_ahtuba.html#reviews-container';
